...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        for Model in [
            AIGenerationRequest, SharedSong, Draft,
            SongPrompt, Library, Song, PlaybackSession, User,
        ]:
        ...
        self.stdout.write(f'  Created songs: {song_completed}, {song_draft}, {song_bob}')

        # ------------------------------------------------------------------
        # Libraries
        # ------------------------------------------------------------------
        alice_lib = Library.objects.create(user=alice, filter_criteria='is_favorite=true')
        ...
        self.stdout.write(f'  Created prompts: {prompt_completed}, {prompt_draft}, {prompt_bob}')
        ...
        self.stdout.write(f'  GenerationRequests:  {AIGenerationRequest.objects.count()}')
